...
from app.database import models  # Import your models package or individual models
...
def run_migrations_online() -> None:
    ...
    # On Windows, force the loop factory to use SelectorEventLoop for psycopg compatibility
    if sys.platform == "win32":
        from asyncio import SelectorEventLoop
        asyncio.run(run_async_migrations(), loop_factory=SelectorEventLoop)
    else:
