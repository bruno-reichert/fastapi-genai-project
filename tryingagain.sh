...
# 8. Update app/chat/streaming.py
...
# 9. Update app/chat/orchestrator.py
...
echo "Backend Agent Grounding setup complete! Clean up script."
rm setup_backend_agent_grounding.sh
EOF

# Execute the creation script
bash setup_backend_agent_grounding.sh